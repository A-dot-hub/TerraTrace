    ...
    <>
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-neutral-100 dark:border-neutral-900">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-neutral-900 dark:bg-white flex items-center justify-center text-white dark:text-neutral-900 font-black shadow-sm group-hover:bg-emerald-600 dark:group-hover:bg-emerald-500 transition-colors">
              <span className="text-sm tracking-tighter font-mono">TT</span>
            </div>
            <div>
        ...
        <div className="p-4 border-t border-neutral-100 dark:border-neutral-900 flex items-center justify-between text-[11px] text-neutral-400 dark:text-neutral-500">
          ...
          <span className="w-2 h-2 rounded-full bg-emerald-500" title="API Status Healthy"></span>
        </div>
      </aside>
    </>
  );
